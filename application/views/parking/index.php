              ...
              <tbody>
                ...
                ?>
                  <tr>
                    ...
                    <td><?php echo $v['parking']['slot_id']; ?></td>
                    <!-- <td><?php echo $v['slot']['slot_name']; ?></td> -->
                    <!-- <?php
                    $checkout_time = strtotime('now');
                    $total_time = ceil((abs($checkout_time - $v['parking']['in_time']) / 60) / 60);

                    $rate_data = $this->model_rates->getRateData($v['parking']['rate_id']);
                    ...
                    ?> -->
                    <td><?= $v['parking']['total_time'] ?> hours</td>
                    <td>$ <?= $v['parking']['earned_amount'] ?></td>
